...
const shapes = {
    ...
    square: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <g>
    <rect width="200" height="200" /></svg>
    </g>`,
    triangle: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
    <g>
    <polygon points="100,10 40,190 190,190" /></svg>
    </g>`,
  };
